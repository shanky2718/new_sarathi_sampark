...
export const initialReturnLoads: ReturnLoad[] = [
  ...
  { loadId: 'LOAD #SS-2050', pickup: 'Delhi', destination: 'Jaipur', distance: 270, cargo: 'FMCG Packaged Goods', weight: '15 Tons', offeredPrice: 22000, estimatedFuelCost: 7100, estimatedProfit: 14900, verifiedShipper: true, shipperName: 'ITC Freight Network', shipperRating: 4.9, postedTime: '1 hour ago', status: 'Available', pickupDate: '2026-08-30', requiredTruckType: 'Container' },
  { loadId: 'LOAD #SS-2051', pickup: 'Hyderabad', destination: 'Vijayawada', distance: 275, cargo: 'Pharmaceutical Supplies', weight: '6 Tons', offeredPrice: 16800, estimatedFuelCost: 4900, estimatedProfit: 11900, verifiedShipper: true, shipperName: 'Cipla Express Logistics', shipperRating: 4.7, postedTime: '2 hours ago', status: 'Available', pickupDate: '2026-08-29', requiredTruckType: 'Box Body' },
  { loadId: 'LOAD #SS-2052', pickup: 'Ahmedabad', destination: 'Surat', distance: 260, cargo: 'Textile Rolls & Fabrics', weight: '18 Tons', offeredPrice: 24500, estimatedFuelCost: 6800, estimatedProfit: 17700, verifiedShipper: true, shipperName: 'Arvind Mills Logistics', shipperRating: 4.6, postedTime: '3 hours ago', status: 'Available', pickupDate: '2026-08-30', requiredTruckType: 'Container' },
  { loadId: 'LOAD #SS-2053', pickup: 'Kochi', destination: 'Coimbatore', distance: 190, cargo: 'Electronic Appliances', weight: '10 Tons', offeredPrice: 15500, estimatedFuelCost: 4200, estimatedProfit: 11300, verifiedShipper: true, shipperName: 'Godrej Consumer Freight', shipperRating: 4.8, postedTime: '4 hours ago', status: 'Available', pickupDate: '2026-08-29', requiredTruckType: 'Box Body' },
  { loadId: 'LOAD #SS-2054', pickup: 'Kolkata', destination: 'Bhubaneswar', distance: 440, cargo: 'Steel Rods & Coils', weight: '25 Tons', offeredPrice: 38000, estimatedFuelCost: 11400, estimatedProfit: 26600, verifiedShipper: true, shipperName: 'JSW Utkal Freight', shipperRating: 4.9, postedTime: '5 hours ago', status: 'Available', pickupDate: '2026-08-31', requiredTruckType: 'Trailer' },
  { loadId: 'LOAD #SS-2055', pickup: 'Bengaluru', destination: 'Mysuru', distance: 140, cargo: 'Organic Agricultural Produce', weight: '7 Tons', offeredPrice: 11200, estimatedFuelCost: 3100, estimatedProfit: 8100, verifiedShipper: false, shipperName: 'Deccan Agro Fresh', shipperRating: 4.2, postedTime: '6 hours ago', status: 'Available', pickupDate: '2026-08-29', requiredTruckType: 'Open Body' },
  { loadId: 'LOAD #SS-2056', pickup: 'Gurugram', destination: 'Chandigarh', distance: 250, cargo: 'Telecom Equipment', weight: '9 Tons', offeredPrice: 19800, estimatedFuelCost: 5600, estimatedProfit: 14200, verifiedShipper: true, shipperName: 'Airtel Network Logistics', shipperRating: 4.8, postedTime: '7 hours ago', status: 'Available', pickupDate: '2026-08-30', requiredTruckType: 'Container' }
];
...
export const initialDocuments: DigitalDocument[] = [
  ...
  { docId: 'DOC-103', title: 'Pollution Under Control (PUC)', category: 'PUC', entity: 'TRK-105 (GJ-01-ZZ-9999)', uploadDate: '2026-02-20', expiryDate: '2026-08-20', status: 'Expired', fileSize: '0.9 MB', documentNumber: 'PUC-GJ01ZZ9999-12' },
  { docId: 'DOC-104', title: 'Heavy Commercial Driving License', category: 'Driving License', entity: 'Rahul Kumar', uploadDate: '2025-11-10', expiryDate: '2030-05-14', status: 'Verified', fileSize: '3.1 MB', documentNumber: 'DL-14201300984' },
  { docId: 'DOC-105', title: 'GST Registration Certificate', category: 'GST Certificate', entity: 'Sarathi Transports Pvt Ltd', uploadDate: '2024-04-01', status: 'Verified', fileSize: '1.2 MB', documentNumber: '29AAACS1234F1Z5' },
  { docId: 'DOC-106', title: 'National Goods Permit', category: 'Permit', entity: 'TRK-101 (KA-01-MJ-2034)', uploadDate: '2026-03-01', expiryDate: '2027-02-28', status: 'Verified', fileSize: '1.5 MB', documentNumber: 'NP-2026-990812' },
  { docId: 'DOC-107', title: 'Trip E-Way Bill #EW-99021', category: 'E-Way Bill', entity: 'TRP-501 (Chennai-Bengaluru)', uploadDate: '2026-08-28', status: 'Verified', fileSize: '850 KB', documentNumber: 'EWB-331099281204' },
  { docId: 'DOC-108', title: 'Commercial Fitness Certificate', category: 'Permit', entity: 'TRK-103 (DL-01-KA-1122)', uploadDate: '2026-06-10', expiryDate: '2027-06-20', status: 'Verified', fileSize: '2.1 MB', documentNumber: 'FIT-DL01KA1122-09' }
];
...
export const initialFuelMetrics: FuelMetric[] = [
  ...
  { id: 'FUEL-102', truckId: 'TRK-101', plateNumber: 'KA-01-MJ-2034', driver: 'Rahul Kumar', fuelConsumedLiters: 210, fuelCost: 19950, avgKmL: 4.7, baselineKmL: 4.8, anomalyPercentage: 2.1, hasAnomaly: false, lastRefillDate: '2026-08-27' },
  { id: 'FUEL-103', truckId: 'TRK-104', plateNumber: 'KA-03-PL-9081', driver: 'Amit Patel', fuelConsumedLiters: 310, fuelCost: 29450, avgKmL: 3.6, baselineKmL: 4.5, anomalyPercentage: 20.0, hasAnomaly: true, anomalyReason: 'Sub-optimal gear shifting on Eastern Ghats uphill incline', lastRefillDate: '2026-08-26' },
  { id: 'FUEL-104', truckId: 'TRK-107', plateNumber: 'MH-14-TY-4532', driver: 'Manoj Yadav', fuelConsumedLiters: 110, fuelCost: 10450, avgKmL: 5.2, baselineKmL: 5.0, anomalyPercentage: -4.0, hasAnomaly: false, lastRefillDate: '2026-08-28' },
  { id: 'FUEL-105', truckId: 'TRK-108', plateNumber: 'HR-55-AA-7654', driver: 'Gopal Dutt', fuelConsumedLiters: 180, fuelCost: 17100, avgKmL: 4.6, baselineKmL: 4.7, anomalyPercentage: 2.1, hasAnomaly: false, lastRefillDate: '2026-08-27' }
];

export const initialMaintenance: MaintenanceRecord[] = [
  { id: 'MNT-301', truckId: 'TRK-105', plateNumber: 'GJ-01-ZZ-9999', serviceType: 'Full Engine Overhaul & Injector Cleaning', scheduledDate: '2026-08-25', status: 'In Progress', cost: 38500, mechanicCenter: 'Tata Motors Authorized Works - Ahmedabad', notes: 'Injectors undergoing pressure testing. Parts dispatched from regional warehouse.' },
  { id: 'MNT-302', truckId: 'TRK-112', plateNumber: 'AP-16-ZZ-4321', serviceType: 'Brake Drum Replacement & Suspension Alignment', scheduledDate: '2026-08-27', status: 'In Progress', cost: 18200, mechanicCenter: 'Vijayawada Commercial Hub Garage', notes: 'Front brake shoes replaced. Rear leaf spring retightening underway.' },
  { id: 'MNT-303', truckId: 'TRK-102', plateNumber: 'MH-12-HQ-5678', serviceType: 'Routine 60,000 KM Periodic Service', scheduledDate: '2026-09-05', status: 'Scheduled', cost: 12000, mechanicCenter: 'Ashok Leyland Service Centre - Thane', notes: 'Scheduled engine oil, oil filter, and fuel filter replacement.' },
  { id: 'MNT-304', truckId: 'TRK-119', plateNumber: 'PB-02-AA-9876', serviceType: 'Clutch Plate & Flywheel Servicing', scheduledDate: '2026-08-20', status: 'Overdue', cost: 24500, mechanicCenter: 'Grand Trunk Road Garage - Ludhiana', notes: 'Clutch slippage reported by driver during heavy load acceleration.' }
];
...
export const initialTransportersReq: TransporterVerification[] = [
  ...
  { id: 'TRN-802', companyName: 'Deccan Freight Express', ownerName: 'Venkat Reddy', gstNumber: '36XYZAB5678G1ZP', truckCount: 8, mobile: '+91-9989022334', city: 'Hyderabad', status: 'Verified', submittedDate: '2026-08-20' },
  { id: 'TRN-803', companyName: 'Coastal Western Carriers', ownerName: 'Mahesh Patel', gstNumber: '24QQQWW8877E1ZX', truckCount: 22, mobile: '+91-9723044556', city: 'Surat', status: 'Pending', submittedDate: '2026-08-28' }
];
...
export const initialShippersReq: ShipperVerification[] = [
  ...
  { id: 'SHP-902', companyName: 'Southern Cotton Mills Producer Org', contactPerson: 'Ramanathan Iyer', gstNumber: '33AAACS9988H1ZV', loadsPosted: 12, mobile: '+91-9444066778', city: 'Coimbatore', status: 'Pending', submittedDate: '2026-08-26' }
];
