...
import { Truck as TruckIcon, Plus, Search, Sparkles, RefreshCw } from 'lucide-react';
            ...
            >
              ...
              <div className="p-4 space-y-3.5 text-xs font-medium">
                ...
                <div className="border-t border-charcoal/5 pt-3.5 mt-2 flex items-center justify-between text-[9px] uppercase tracking-wider font-bold text-charcoal/50">
                  <span>PUC: {truck.pucExpiry ? new Date(truck.pucExpiry).toLocaleDateString(undefined, {month: 'short', year: '2-digit'}) : 'N/A'}</span>
                  <span>Fitness: {truck.fitnessExpiry ? new Date(truck.fitnessExpiry).toLocaleDateString(undefined, {month: 'short', year: '2-digit'}) : 'N/A'}</span>
                </div>
              </div>
            </div>
          ))}
